...
def FindVelocity(  ):
    ...
    Lv = path_profile[profile_index][2] * (2 + curve*ROBOT_TRACK_WIDTH)/2
    Rv = path_profile[profile_index][2] * (2 - curve*ROBOT_TRACK_WIDTH)/2
...
wayptFilename = "../"+ wyptPath + "/output.csv"
...
#read in config file
path_profile = []
with open(wayptFilename,"r+") as file:
    for i,line in enumerate(file.readlines()):
        if(i==0):
            print(line)     #First line is compile date
        else:
